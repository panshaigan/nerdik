...
class InterestController extends Controller
{
    ...
    public function removeEvent(Event $event): RedirectResponse
    {
    ...
    public function addActivity(Activity $activity): RedirectResponse
    {
    ...
    public function removeActivity(Activity $activity): RedirectResponse
    {
