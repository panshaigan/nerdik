...
final class BrowseListingFilterBag
{
    ...
    public function __construct(
        ...
        public readonly bool $onlyFreePlaces,
    ...
    public static function fromRequest(Request $request): self
    {
        ...
        return new self(
            ...
            onlyFreePlaces: filter_var($request->input('only_free_places', false), FILTER_VALIDATE_BOOLEAN),
    ...
    public function withoutBBox(): self
    {
        return new self(
            ...
            onlyFreePlaces: $this->onlyFreePlaces,
            minLat: null,
            maxLat: null,
            minLng: null,
            maxLng: null,
