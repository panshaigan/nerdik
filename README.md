...
To load foundations (places, tags) plus sample events, instances, slots, and activities for testing:
...
| Email             | Password  |
|-------------------|-----------|
| alice@nerdik.test | password  |
| bob@nerdik.test   | password  |

Sample data includes: an organization, two public events with instances and slots, and two activities attached to slots so you can try browse, join/leave, and waitlist flows.
