    ...
    'configs' => [
        ...
        'tinymce' => [
            ...
            'HTML.Allowed' => implode(',', [
                ...
                'table[border|style|class]', 'thead', 'tbody', 'tfoot', 'caption',
            ...
            'CSS.AllowedProperties' => implode(',', [
                ...
                'text-decoration', 'padding', 'padding-left', 'padding-right',
                'margin', 'margin-left', 'margin-right', 'margin-top', 'margin-bottom',
                'float',
                'color', 'background-color', 'text-align', 'vertical-align',
                'border', 'border-collapse', 'border-width', 'border-style', 'border-color', 'border-spacing',
