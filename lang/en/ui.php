...
return [
    ...
    'events' => [
        ...
        'signup_periods_heading' => 'Activity signup windows',
        'signup_periods_help' => 'Participants can join or join the waitlist for activities at this event only during these windows. A window may open before the event starts, but it must close by the event end. Leave the list empty (clear all rows) for no time restriction. Add several non-overlapping windows if needed. “Max activities” caps how many activities someone may sign up for during that window (empty or 0 = unlimited).',
        'signup_period_starts' => 'Signup opens',
        'signup_period_ends' => 'Signup closes',
        'signup_period_max_activities' => 'Max activities per person (optional)',
        'signup_period_max_activities_hint' => 'How many activities someone may sign up for during this window. Leave empty or 0 for unlimited.',
        'signup_period_add' => 'Add another window',
        'signup_outside_period' => 'Signups for this event are not open right now.',
        'signup_period_limit_reached' => 'You have already signed up for :max activities in the current signup window for this event.',
        'signup_schedule_overlap' => 'This activity overlaps in time with another activity you are already signed up for at this event.',
        'signup_periods_need_event_dates' => 'Set the event start and end dates before configuring signup windows.',
        'signup_period_incomplete' => 'Fill in both start and end for each signup window, or remove the row.',
        'signup_period_invalid_datetime' => 'Could not read one of the signup window dates.',
        'signup_period_end_after_start' => 'Signup must end on or after it starts.',
        'signup_period_end_before_event_end' => 'Signup must close on or before the event ends.',
        'signup_period_end_not_past' => 'The signup window cannot end entirely in the past.',
        'signup_period_max_invalid' => 'Enter a positive number or leave empty for unlimited.',
        'signup_periods_must_not_overlap' => 'Signup windows must not overlap each other.',
    ],
    'slots' => [
        'create_slot' => 'Create slot',
        'mass_create_slots' => 'Mass create slots',
