...
class ManageActivityFormLotteryTest extends TestCase
{
    ...
    public function test_self_hosted_lottery_activity_saves_without_resolve_trigger_error(): void
    {
        ...
        Livewire::actingAs($user)
            ...
            ->set('cancellation_deadline_in_hours', 24)
        ...
        $this->assertSame(24, $activity->cancellation_deadline_in_hours);
