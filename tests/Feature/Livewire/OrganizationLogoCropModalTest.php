...
final class OrganizationLogoCropModalTest extends TestCase
{
    ...
    #[Test]
    public function organization_form_renders_crop_modal_outside_org_form(): void
    {
        ...
        Livewire::actingAs($user)
            ...
            ->assertSeeHtml('data-org-form');
    }

    #[Test]
    public function org_form_has_crop_upload_hooks(): void
    {
        $user = User::factory()->create(['is_event_organizer' => true]);
