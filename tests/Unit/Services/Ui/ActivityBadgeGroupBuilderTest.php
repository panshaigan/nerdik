...
final class ActivityBadgeGroupBuilderTest extends TestCase
{
    ...
    public function activity_hero_orders_type_tags_then_age_and_hides_meta_not_in_surface(): void
    {
        ...
        $this->assertNotNull(collect($items)->first(fn (ActivityBadgeItem $i) => $i->label === 'Alpha'));
        $this->assertNotNull(collect($items)->first(fn (ActivityBadgeItem $i) => $i->label === 'Beta'));
    }
    ...
    #[Test]
    public function activity_hero_treats_zero_age_as_open_bound(): void
    {
        $activity = Activity::factory()->create([
            'minimum_age' => 0,
            'maximum_age' => 0,
    ...
    #[Test]
    public function activity_hero_treats_zero_minimum_as_max_only(): void
    {
        $activity = Activity::factory()->create([
            'minimum_age' => 0,
            'maximum_age' => 16,
