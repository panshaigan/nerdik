...
>
    ...
    <div class="grid grid-cols-1 gap-3 px-4 sm:grid-cols-3 sm:px-6 lg:px-8">
        ...
        <div class="group ui-activity-show-info-panel ui-activity-show-stat-panel flex min-w-0 items-center rounded-2xl">
