...
<div>
    @if (config('services.google.client_id'))
        <div class="mb-4">
            <a href="{{ route('google.redirect') }}" class="inline-flex w-full justify-center items-center gap-2 rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50">
        ...
        <div class="relative my-4">
            ...
            <div class="relative flex justify-center text-sm"><span class="bg-white px-2 text-gray-500">{{ __('or') }}</span></div>
        </div>
    @endif
    ...
    <form wire:submit="register">
        ...
        <div>
            ...
            <x-text-input wire:model="nickname" id="nickname" class="block mt-1 w-full" type="text" name="nickname" required autofocus autocomplete="nickname" />
