...
<div id="ui-auth-register-root" class="ui-auth ui-auth-register" data-ui="auth-register-root">
    @if (config('services.google.client_id'))
        <div class="mb-4">
            <x-button id="ui-auth-register-google" :link="route('google.redirect')" class="btn-outline w-full gap-2 border-base-300 ui-action ui-action-google" data-ui="auth-register-google">
