...
<div id="ui-auth-login-root" class="ui-auth ui-auth-login" data-ui="auth-login-root">
    ...
    @if (config('services.google.client_id'))
        <div class="mb-4">
            <x-button id="ui-auth-login-google" :link="route('google.redirect')" class="btn-outline w-full gap-2 border-base-300 ui-action ui-action-google" data-ui="auth-login-google">
