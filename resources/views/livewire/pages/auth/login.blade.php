...
<div id="ui-auth-login-root" class="ui-auth ui-auth-login" data-ui="auth-login-root">
    ...
    @if (config('services.discord.client_id'))
        <div class="mb-4">
            ...
            <x-button id="ui-auth-login-discord" :link="route('discord.redirect')" :no-wire-navigate="true" class="btn-outline w-full gap-2 border-base-300 ui-action ui-action-discord" data-ui="auth-login-discord">
                ...
                {{ __('ui.auth.log_in_with_discord') }}
            </x-button>
        </div>
    @endif
