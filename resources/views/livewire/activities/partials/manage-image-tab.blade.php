    ...
    <fieldset class="fieldset py-0">
        ...
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            ...
            <label class="flex cursor-pointer items-start gap-3 rounded-lg border border-base-300 p-3 has-[:checked]:border-primary has-[:checked]:bg-primary/5">
                ...
                />
                <span>
                    <span class="block text-sm font-semibold text-base-content">{{ __('ui.activities.image_from_gallery') }}</span>
                    <span class="mt-0.5 block text-xs text-base-content/70">{{ __('ui.activities.image_from_gallery_help') }}</span>
                </span>
            </label>
            <label class="flex cursor-pointer items-start gap-3 rounded-lg border border-base-300 p-3 has-[:checked]:border-primary has-[:checked]:bg-primary/5">
                <input
        ...
        <div class="space-y-6">
            <div class="rounded-lg border border-base-200 bg-base-200/40 p-6">
                @if ($this->availableGalleryImages === [])
                    <p class="text-sm text-base-content/80">{{ __('ui.activities.image_gallery_empty') }}</p>
                @else
                    <div
            ...
            @if ($gallery_media_id !== null && filled($galleryCropSourceUrl ?? null))
                <x-image-crop-upload
                    ...
                    file-input-id="ui-activity-gallery-crop-file"
                    ...
                    :choose-label="__('ui.common.upload_image')"
