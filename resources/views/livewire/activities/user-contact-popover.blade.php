@php
    ...
    $hasFooterActions = $targetUser !== null && (
        $activityInviteSubjectId
        || $organizationInviteSubjectId
        || ($organizationJoinSubjectId && $organizationJoinRecipientId)
...
>
    <div class="min-h-0 flex-1 space-y-5 overflow-x-hidden overflow-y-auto p-4 text-sm" data-ui="user-contact-popover-body">
        @if ($targetUser !== null)
