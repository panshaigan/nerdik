    ...
    <div class="flex w-full flex-col gap-4 p-3">
        <div class="flex w-full flex-col gap-4 md:flex-row md:items-end">
            <x-select
                ...
                :options="$browsePlaceOptions ?? []"
                :placeholder="__('ui.browse.any')"
                placeholder-value=""
                class="ui-field ui-field-place w-full max-w-md"
                data-ui="browse-place-select"
                :omit-error="true"
            />
            <x-select
                id="browse_organization_id"
                wire:model.live="organization_id"
                :label="__('ui.browse.organization')"
                :options="$browseOrganizationOptions ?? []"
                :placeholder="__('ui.browse.any')"
                placeholder-value=""
                class="ui-field ui-field-organization w-full max-w-md"
                data-ui="browse-organization-select"
                :omit-error="true"
            />
        </div>
